...
<body>
    ...
    <div class="main-content">
        <div class="inquiry-details">
            <!-- Navigation Buttons -->
            <div class="mb-4" style="display:flex;gap:0.75rem;flex-wrap:wrap;align-items:center;">
                <a href="{{ route('inquiries.index') }}" class="btn-primary">
                    <i class="fas fa-arrow-left"></i>
                    <span>Back to Inquiry List</span>
                </a>
                <a href="{{ route('inquiry.history', $inquiry->InquiryID) }}" class="btn-secondary">
                    <i class="fas fa-history"></i>
                    <span>View Full Timeline &amp; Log</span>
                </a>
            </div>
            ...
            @endif
                ...
                <!-- Assignment Time -->
                <div class="detail-group">
                    <div class="detail-label">Assignment Time</div>
                    <div class="detail-value">
                        @if($inquiry->AgencyID && $inquiry->agency && $inquiry->assignment_date)
                            <div class="flex items-center gap-3">
                                <div class="w-3 h-3 bg-green-500 rounded-full"></div>
                                <div>
                                    <div class="font-medium text-green-700">
                                        {{ $inquiry->assignment_date->format('l, F j, Y') }}
                                    </div>
                                    <div class="text-lg font-semibold text-green-800">
                                        {{ $inquiry->assignment_date->format('g:i A') }}
                                    </div>
                                    <div class="text-sm text-green-600">
                                        ({{ $inquiry->assignment_date->diffForHumans() }})
                                    </div>
                                </div>
                            </div>
                        @elseif($inquiry->AgencyID && $inquiry->agency)
                            <div class="flex items-center gap-3">
                                <div class="w-3 h-3 bg-orange-500 rounded-full"></div>
                                <div>
                                    <div class="font-medium text-orange-700">
                                        {{ $inquiry->updated_at ? $inquiry->updated_at->format('l, F j, Y') : 'Unknown date' }}
                                    </div>
                                    <div class="text-lg font-semibold text-orange-800">
                                        {{ $inquiry->updated_at ? $inquiry->updated_at->format('g:i A') : 'Unknown time' }}
                                    </div>
                        ...
                        @else
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <div class="font-medium text-gray-500">Not assigned yet</div>
                                    <div class="text-sm text-gray-400">Agency assignment pending</div>
                                </div>
                            </div>
                        @endif
                    </div>
